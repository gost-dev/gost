module github.com/gost-dev/gost
...
require (
	...
	google.golang.org/grpc v1.61.0-dev.0.20240216210838-c63d9258db23 // indirect
...
replace github.com/go-gost/relay => github.com/gost-dev/relay v0.0.0-20240219130319-d23e3e6d1624
